 ...
 */
public class XProcTestSuiteTest extends AbstractSuiteTest {

    @Test
    public void xproc_include_loop() throws Exception
    {
        testxproc(getClass().getClassLoader().getResource("xproc/test/input-xinclude-loop-source.xml"),
             XIncludeFatalException.class, false, false);
    }
    @Test
    public void xproc_include_01() throws Exception
    {
        testxproc(getClass().getClassLoader().getResource("xproc/test/xinclude-001.xml"),
    ...
    {
        testxproc(getClass().getClassLoader().getResource("xproc/test/xinclude-002.xml"),
    ...
    {
        testxproc(getClass().getClassLoader().getResource("xproc/test/xinclude-003.xml"),
    ...
    {
        testxproc(getClass().getClassLoader().getResource("xproc/test/input-en-cs.xml"),
    ...
    {
        testxproc(getClass().getClassLoader().getResource("xproc/test/xinclude-o001.xml"),
    ...
    {
        testxproc(getClass().getClassLoader().getResource("xproc/test/xinclude-o002.xml"),
    ...
    {
        testxproc(getClass().getClassLoader().getResource("xproc/test/xinclude-o003.xml"),
    ...
    {
        testxproc(getClass().getClassLoader().getResource("xproc/test/xinclude-o004.xml"),
    ...
    {
        testxproc(getClass().getClassLoader().getResource("xproc/test/xinclude-o005.xml"),
    ...
    {
        testxproc(getClass().getClassLoader().getResource("xproc/test/xinclude-o006.xml"),
